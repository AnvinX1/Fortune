        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-sm text-blue-200 uppercase tracking-widest">Service Categories</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-2">100%</div>
              <div className="text-sm text-blue-200 uppercase tracking-widest">Custom Solutions</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-2">24hr</div>
              <div className="text-sm text-blue-200 uppercase tracking-widest">Quote Delivery</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-2">5000+</div>
              <div className="text-sm text-blue-200 uppercase tracking-widest">Projects Delivered</div>
            </div>
          </div>
        </div>
      </section>
